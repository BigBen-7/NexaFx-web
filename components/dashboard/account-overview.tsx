...
export function AccountOverview({
  ...
  useEffect(() => {
    if (wsBalance && wsBalance.length > 0) {
      ...
      if (ngnItem) setBalance(formatCurrency(ngnItem.amount, "NGN"));
      else if (usdItem) setBalance(formatCurrency(usdItem.amount, "USD"));
      else setBalance(formatCurrency(firstItem.amount, firstItem.currency));
    }
  }, [wsBalance]);
